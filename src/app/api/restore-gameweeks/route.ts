...
export async function POST() {
  try {
    ...
    const gameweekData = [
      {
        gameweekNumber: 1,
        lockTime: new Date('2024-08-15T19:00:00Z'), // Fri 15 Aug 19:00 UTC
        isSettled: true,
        settledAt: new Date('2024-08-19T00:00:00Z'), // Mon 18 Aug end
        fixtures: [
      ...
      {
        gameweekNumber: 2,
        lockTime: new Date('2024-08-22T19:00:00Z'), // Fri 22 Aug 19:00 UTC
        isSettled: true,
        settledAt: new Date('2024-08-26T00:00:00Z'), // Mon 25 Aug end
        fixtures: [
      ...
      {
        gameweekNumber: 3,
        lockTime: new Date('2024-08-30T14:00:00Z'), // Sat 30 Aug 14:00 UTC
        isSettled: true,
        settledAt: new Date('2024-08-31T23:59:59Z'), // Sun 31 Aug end
        fixtures: [
      ...
      {
        gameweekNumber: 4,
        lockTime: new Date('2024-09-06T14:00:00Z'), // Fri 6 Sep 14:00 UTC
        isSettled: false, // Current gameweek
        settledAt: null,
        fixtures: [
      ...
      {
        gameweekNumber: 5,
        lockTime: new Date('2024-09-20T06:30:00Z'), // Sat 20 Sep 06:30 UTC
        isSettled: false,
        settledAt: null,
        fixtures: [
    ...
    return NextResponse.json({ 
      success: true, 
      message: 'Gameweeks 1-5 restored successfully',
      results 
    })
